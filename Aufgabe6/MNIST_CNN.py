...
l_conv1 = layers.Conv2DLayer(l_input, num_filters=conv1_filter, filter_size=(conv1_size, conv1_size), nonlinearity=sigmoid) #Hidden Layer
l_pool1 = layers.MaxPool2DLayer(l_conv1, pool_size=(2, 2)) # 2x2 MaxPool
l_fc_out = layers.DenseLayer(l_pool1, num_units=out_size, nonlinearity=softmax) #Ausgabeschicht
